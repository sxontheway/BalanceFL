...
if __name__ == '__main__':
    ...
    parser.add_argument("--exp_name", default="fedprox", type=str, help="exp name")
    ...
    for i in range(num_client):  
        ...
        p = Fed_client(
            ...
            client_i_data, client_i_label, training_num_per_cls, 
            test_data, test_label, state_list, model_list, idx=i
            ) 
        p.daemon = True
        p.start()
