...
def calculate_prior(
    num_classes, img_max=None, prior=None, prior_txt=None, reverse=False
):
    if prior_txt:
        labels = []
...
def create_loss(
    num_cls, img_num_per_cls=None, img_max=None, prior=None, prior_txt=None, device=None
):
    print("Loading PriorCELoss Loss.")
    return PriorCELoss(
        num_classes=num_cls,
        img_num_per_cls=img_num_per_cls,
        img_max=img_max,
        prior=prior,
        prior_txt=prior_txt,
    )
